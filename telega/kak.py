...
token = '5694266204:AAEDcKoaj5HrVRVGD8NNqioryT-VZeAOVoc'
...
def zodiac3_sign(message):
    if e == 1 and z <= 19:
        ...
        bot.send_message(message.chat.id, "Вы Козерог")
    elif e == 1 and z >= 20 and z <= 31:
        bot.send_message(message.chat.id, "Вы Водолей")
    elif e == 2 and z >= 1 and z <= 19:
        bot.send_message(message.chat.id, "Вы Водолей")
    elif e == 2 and z >= 20 and z <= 29:
        bot.send_message(message.chat.id, "Вы Рыбы")
    elif e == 3 and z >= 1 and z <= 20:
        bot.send_message(message.chat.id, "Вы Рыбы")
    elif e == 3 and z >= 21 and z <= 31:
        bot.send_message(message.chat.id, "Вы Овен")
    elif e == 4 and z >= 1 and z <= 20:
        bot.send_message(message.chat.id, "Вы Овен")
    elif e == 4 and z >= 21 and z <= 30:
        bot.send_message(message.chat.id, "Вы Телец")
    elif e == 5 and z >= 1 and z <= 20:
        bot.send_message(message.chat.id, "Вы Телец")
    elif e == 5 and z >= 21 and z <= 31:
        bot.send_message(message.chat.id, "Вы Близнецы")
    elif e == 6 and z >= 1 and z <= 20:
        bot.send_message(message.chat.id, "Вы Близнецы")
    elif e == 6 and z >= 21 and z <= 30:
        bot.send_message(message.chat.id, "Вы Рак")
    elif e == 7 and z >= 1 and z <= 22:
        bot.send_message(message.chat.id, "Вы Рак")
    elif e == 7 and z >= 23 and z <= 31:
        bot.send_message(message.chat.id, "Вы Лев")
    elif e == 8 and z >= 1 and z <= 22:
        bot.send_message(message.chat.id, "Вы Лев")
    elif e == 8 and z >= 23 and z <= 31:
        bot.send_message(message.chat.id, "Вы Дева")
    elif e == 9 and z > 1 and z <= 22:
        bot.send_message(message.chat.id, "Вы Дева")
    elif e == 9 and z >= 23 and z <= 30:
        bot.send_message(message.chat.id, "Вы Весы")
    elif e == 10 and z >= 1 and z <= 22:
        bot.send_message(message.chat.id, "Вы Весы")
    elif e == 10 and z >= 23 and z <= 31:
        bot.send_message(message.chat.id, "Вы Скорпион")
    elif e == 11 and z >= 1 and z <= 22:
        bot.send_message(message.chat.id, "Вы Скорпион")
    elif e == 11 and z >= 23 and z <= 30:
        bot.send_message(message.chat.id, "Вы Стрелец")
