...
class Calculator(QWidget):
    ...
    def initUI(self):
        ...
        self.div3_3 = QPushButton('%', self)
        self.div3_3.resize(35, 50)
        self.div3_3.move(40, 320)

        self.div2_2 = QPushButton('//', self)
        self.div2_2.resize(35, 50)
        self.div2_2.move(80, 320)

        self.sqrt2_2 = QPushButton('^2', self)
        self.sqrt2_2.resize(35, 50)
        self.sqrt2_2.move(120, 320)
        ...
        self.div3_3.clicked.connect(self.div_3)
        self.div2_2.clicked.connect(self.div_2)
        self.sqrt2_2.clicked.connect(self.sqrt_2)
